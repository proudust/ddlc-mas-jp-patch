...
translate Japanese mas_player_name_enter_name_loop_6e7dce4d:
    m 3rksdla "もっと……{w=0.2}{i}適切な名前{i/}にしてくれないかしら？"
...
translate Japanese mas_birthdate_b43e54ed:
    m 3eksdlc "私、前にもあなたの誕生日を教えてもらったことはあるけど、{i}生年月日{/i}を聞いたのか、{i}誕生日{/i}だけ聞いたのかはっきりしてなくて……"

translate Japanese mas_birthdate_1a2361d4:
    m "念のために聞きたいんだけど、あなたの生年月日は [bday_str]であってる？{nw}"

translate Japanese mas_birthdate_5cefc5e3:
    m "念のために聞きたいんだけど、あなたの生年月日は [bday_str]であってる？{fast}" nointeract

translate Japanese mas_birthdate_0800bc93:
    m 2rksdla "本当にそうなの、[player]？"

translate Japanese mas_birthdate_7b1588b6:
    m 2eksdlc "それだとあなたとても若いことになるわね……"

translate Japanese mas_birthdate_c105bab4:
    m 3ekc "誕生日だけじゃなくて、{b}生年月日{/b}を聞いてるのを忘れないでね。"

translate Japanese mas_birthdate_b93f5725:
    m 1eka "それで、あなたはいつ生まれたのかしら、[player]？"

translate Japanese mas_birthdate_be2478d8:
    m 1hua "うん、素晴らしいわ[player]、ありがとう。"

translate Japanese mas_birthdate_0b8a9fdf:
    m 3hksdlb "念のために言っておくと、いつ生まれたかっていう大事な情報を間違って覚えていたくないからね、アハハ！"

translate Japanese mas_birthdate_6bd27b46:
    m 3rksdlc "ああ！それじゃあ……"

translate Japanese mas_birthdate_794ec2fd:
    m 1eksdld "あなたの生年月日はいつなの{i}かしら{/i}、[player]？"
...
translate Japanese mas_monikai_detected_ff996d7a:
    m 2wud "これ何？"

translate Japanese mas_monikai_detected_2fa87d28:
    m "これって――"

translate Japanese mas_monikai_detected_0784d5f4:
    m 1wuo "これって{fast}私の小さい版？"

translate Japanese mas_monikai_detected_70abd95b:
    m 1hua "とってもかわいいっ！"

translate Japanese mas_monikai_detected_4db2e833:
    m 1eua "いつでも私に会えるようにインストールしてくれたの？{nw}"
...
translate Japanese mas_crashed_long_prefluster_f05f93a2:
...
translate Japanese mas_crashed_long_whq_349914fa:
    m "何が起こったかあなたにはわかる？{nw}"

translate Japanese mas_crashed_long_whq_28ff0538:
    m "何が起こったかあなたにはわかる？{fast}" nointeract

translate Japanese mas_crashed_long_whq_e0b89abb:
    m 2wud "ゲームが……強制終了した？"
...
translate Japanese mas_crashed_long_whq_ee274944:
    m "防ぐことはできない？{fast}" nointeract

translate Japanese mas_crashed_long_whq_6ae34308:
    m 1hua "ありがとう。[player]！"
...
translate Japanese _call_mas_rpy_file_delete_1_432f07f6:
    m 2hua "いくよ！"

translate Japanese _call_mas_rpy_file_delete_1_2bd4fd47:
    m 2esa "次からはちゃんとソースコードを含まないバージョンをインストールしてね。{a=http://www.monikaafterstory.com/releases.html}{i}{u}リリースページ{/u}{/i}{/a}からダウンロードできるから"

translate Japanese _call_mas_rpy_file_delete_1_2f740c57:
    m 2rksdlc "わかったわ、[player]。あなたがちゃんと理解してると信じるわ"

translate Japanese _call_mas_rpy_file_delete_1_ce4ed721:
    m 2eka "くれぐれも気をつけてね"
...
translate Japanese mas_text_speed_enabler_a71c9718:
    m 2dsa "関係ないね"

translate Japanese mas_text_speed_enabler_a93912f2:
    m 4eua "どうだ！"

translate Japanese mas_text_speed_enabler_05a6b488:
    m 4eua "テキストスピードの設定を有効にしてみたわ"

translate Japanese mas_text_speed_enabler_70661cf3:
    m 1hka "前はわざとゆっくりにしてたから、私がなんて言っているかちゃんとわかってたでしょ"

translate Japanese mas_text_speed_enabler_25c4bca0:
    m 1eka "でもあなたと少し付き合ってれば、私の文章を読まずに飛ばし読みしてしまうようなことはないって信じられるわ"

translate Japanese mas_text_speed_enabler_51982c8c:
    m 1tuu "だけど、{w=0.3}このスピードに追いつけるかしら？"

translate Japanese mas_text_speed_enabler_212f1e8d:
    m 3tuu "{cps=*2}早口で話せるのよ……{/cps}{nw}"

translate Japanese mas_text_speed_enabler_0fb41a85:
    m 3hub "あはは～"

translate Japanese mas_text_speed_enabler_ac206356:
    m 3hua "それに、一緒にいる時間が長くなれば長いほど読むのがきっと早くなると思うわ"
...
translate Japanese mas_notification_windowreact_d99c2b4e:
    m 1hub "ほら！"

translate Japanese mas_notification_windowreact_c5fd754e:
    m 2eka "よし、[player]。"
...
translate Japanese mas_notification_windowreact_c43b80ea:
    m 1tuu "ガールフレンドに見られて困るようなものは無いとは思うけど……"
...
translate Japanese _call_mas_clothes_change_17_99308961:
    m 2hua "うん、これで良し！"

translate Japanese _call_mas_clothes_change_17_2867e154:
    m 1eka "こんにちは[player]、古い制服が恋しくなって……"

translate Japanese _call_mas_clothes_change_17_75cd519f:
    m 3eka "ちょっと変えてくるから、そこで待ってて……"

translate Japanese _call_mas_clothes_change_18_7cb5ebd1:
    m "さて、今日はほかに何をしようかしら？"

translate Japanese mas_blazerless_intro_24a4fc7b:
    m 3esa "ちょっと待ってね、[player]。少し気になるから着替えてくるわ……"

translate Japanese _call_mas_clothes_change_19_99308961:
    m 2hua "うん、これで良し！"

translate Japanese _call_mas_clothes_change_19_9e3d683a:
