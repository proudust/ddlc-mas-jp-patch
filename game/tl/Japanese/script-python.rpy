...
translate Japanese _call_mas_w_cmd_1_da20e6c6:
    m 3eub "これは2つの式でどちらの評価もTrueだったから、処理全体ではTrueが返ってくるわ"

translate Japanese _call_mas_w_cmd_2_d79dc422:
    m 3eua "この例では、1つ目の式はFalseと評価されるわね"

translate Japanese _call_mas_w_cmd_2_1967a689:
    m "すでに少なくとも1つ式の評価がFalseだとわかる。だから、and以降の処理がどうなるかは関係ない"

translate Japanese _call_mas_w_cmd_2_7e7f5c99:
...
translate Japanese _call_mas_w_cmd_3_e3f7693e:
    m 3eub "この式はTrueで評価されるわ"

translate Japanese _call_mas_w_cmd_4_b16cf7f3:
    m 3eua "これもorの前の式がTrueね。だから処理全体ではTrueが返ってくるよ"

translate Japanese _call_mas_w_cmd_5_a6d09889:
    m 3eua "この場合は、orの前の式の評価はFalseね"

translate Japanese _call_mas_w_cmd_5_7fc327a3:
    m "でも[val_a]は[val_c]以上だから、後の式の評価はTrueになる"

translate Japanese _call_mas_w_cmd_5_feee2cde:
    m 3eub "少なくとも1つの式がTrueになっているから、処理全体ではTrueが返ってくるのよ"

translate Japanese _call_mas_w_cmd_6_dff5baef:
    m 3eua "さっきと同じで、orの前の式の評価はFalseね"

translate Japanese _call_mas_w_cmd_6_1e248dfa:
    m "そして[val_a]は[val_c]じゃないから、後の式の評価もFalseになる"

translate Japanese _call_mas_w_cmd_6_09e6dc9b:
    m 3eub "どちらの式もTrueじゃなかったから、処理全体ではFalseが返ってくるの"

translate Japanese _call_mas_x_cmd_6_a2d7b908:
    m 3eub "おさらいするね。OR演算子を使うときは、orの前後どちらかの評価がTrueであれば、Trueで評価されるのよ
"

translate Japanese _call_mas_x_cmd_6_b6922dbd:
...
translate Japanese _call_mas_wx_cmd_42_d6f27c04:
    m 3eua "カッコ内の処理はTrueで、notは結果を逆にする演算子。だからこの処理ではFalseが返ってくるわ"

translate Japanese _call_mas_wx_cmd_43_b19bcd5d:
    m 3eub "この場合、もうdはTrueだとわかってたわね。"

translate Japanese _call_mas_wx_cmd_43_6fe4657c:
    m "NOT演算子がeを逆にしてるから、andの後はTrueとして評価されている"

translate Japanese _call_mas_wx_cmd_43_57fa0f17:
    m 3eua "andの前後両方ともTrueとして評価されているから、この処理ではTrueが返ってきているの"

translate Japanese _call_mas_wx_cmd_43_8cb6ff69:
    m 1eua "比較演算は、あらゆるプログラミング言語のあらゆる場所で使われているわ"

translate Japanese _call_mas_wx_cmd_43_0cb6e0e3:
    m 1hua "プログラミングを生業にすると、多くのコードは比較演算でTrueかFalseかをチェックしているだけだとわかるわ。だから正しいコードを書くことが大事になるのよ"

translate Japanese _call_mas_wx_cmd_43_31e7e117:
    m 1eksdla "仕事でプログラミングが必要じゃなかったとしても、比較演算は今後のレッスンでいっぱい使うつもりだから、ちゃんと復習しておいてね！"

translate Japanese _call_mas_wx_cmd_43_3ecaaf94:
    m 1eua "今日はここまでにしましょうか"

translate Japanese _call_mas_wx_cmd_43_b43554c2:
    m 1hua "ご清聴、ありがとうございました！"
...
translate Japanese _call_mas_wx_cmd_44_08084383:
    m "「a_number」の部分に、整数の[num_store]が格納されているよ"

translate Japanese _call_mas_wx_cmd_44_a833ab6c:
    m "ここでa_numberを入力すると……"

translate Japanese _call_mas_w_cmd_7_59fb3cfe:
    m 3eub "変数a_numberに格納された値を取得できるんだ"

translate Japanese _call_mas_x_cmd_7_9981b4ba:
    m "イコール（=）を使って、[num_store]という値をa_numberという変数の中に格納したことはわかってもらえたかな？"

translate Japanese _call_mas_x_cmd_7_96343da1:
    m 1eub "これを、変数の代入と呼ぶのよ。イコールの右側にあるもの全部を、イコール左側にある変数のなかに収めちゃうの"

translate Japanese _call_mas_x_cmd_7_76f700d6:
    m 1eua "代入は、右側から左側へ向かってされるからね。{w=0.3}説明のために、新しく「b_number」って変数を作るね"

translate Japanese _call_mas_w_cmd_8_6ace34d2:
    m "代入では、まずイコールの右側の処理が行われて、{w=0.2}それに合うデータの型とそのデータに見合うメモリの量が自動的に選ばれるわ"

translate Japanese _call_mas_w_cmd_8_cc4b2175:
    m "設定されたメモリはイコールの左側、変数へ関連付けされるの"

translate Japanese _call_mas_w_cmd_8_5d9afca0:
    m 1eub "Pythonで値が格納された変数を入力すると、その変数の中身を検索して、関連付けられた値がでてくるわけね"

translate Japanese _call_mas_w_cmd_8_13245820:
    m 3eub "これだと、まずa_numberは[num_store]に置き換わるわね。{w=0.2}そして、[num_store] - [b_num_store] が処理されてb_numberの値になる"

translate Japanese _call_mas_x_cmd_8_a59ec156:
    m 1eua "処理の結果は変数b_numberを入力すれば確認できるわ"

translate Japanese _call_mas_x_cmd_8_b4037d80:
    m "変数b_numberに関連付けられた値が取得されて、コンソール上に表示される"

translate Japanese _call_mas_wx_cmd_45_216f8a74:
...
translate Japanese _call_mas_wx_cmd_51_cd7134bf:
    m 3eua "こうやってaという変数に10という整数を代入したよね"

translate Japanese _call_mas_wx_cmd_51_5c70abfb:
    m "ここでインタープリタにaと打ち込むと……"

translate Japanese _call_mas_wx_cmd_52_1ce945e2:
    m 3eub "Pythonは変数aの中に代入された値、この場合は10ね、を探してきて表示してくれるの"

translate Japanese _call_mas_wx_cmd_52_b6c4d4b6:
    m "ここで、もし10と打ち込んだ場合…"

translate Japanese _call_mas_wx_cmd_53_1f25e2ec:
    m 3hua "これでもPythonは10と表示してくれるの！"

translate Japanese _call_mas_wx_cmd_53_5e3c67ad:
    m 3eua "これは、Pythonインタープリタが10という値をそのまま返したということよ。aと打ち込んだときと違って、変数に代入された値を探して表示してるわけじゃない"

translate Japanese _call_mas_wx_cmd_53_64a9ce78:
    m "Pythonが受け取った値をそのまま表示できる、今みたいな書き方のことをリテラルと言うの"

translate Japanese _call_mas_wx_cmd_53_a0dcd1ed:
    m 3eub "前に型のレッスンで教えた事覚えてるかな。あそこで教えた型は全部リテラルで書けるのよ"

translate Japanese _call_mas_wx_cmd_55_3aa098b0:
...
translate Japanese _call_mas_wx_cmd_70_78d077e3:
    m 1eua "次はstring型でどうなるか見てみるね"

translate Japanese _call_mas_wx_cmd_72_05f24f8b:
    m 3eub "文字列は、全てTrueになるわ。文字が無いスペースだけだとしても、その真偽値はTrueね"

translate Japanese _call_mas_wx_cmd_73_22d4c2e2:
    m "でも空の文字列、何も入っていない長さが0の文字列ね、は真偽値がFalseになるの"

translate Japanese _call_mas_wx_cmd_73_73e74e92:
    m 1eua "次はNoneを見てみましょうか"

translate Japanese _call_mas_wx_cmd_74_8661fc42:
    m 1eub "Noneは常に真偽値がFalseになるの"

translate Japanese _call_mas_wx_cmd_74_5273e71f:
    m 1eua "今まで見てきた値同士を比較する場合、まず真偽値で評価された後に比較が行われるわ"

translate Japanese _call_mas_wx_cmd_74_9ebe82de:
    m 1hua "これも例を見ていこうね"

translate Japanese _call_mas_wx_cmd_74_fd055737:
    m 3eua "まず、いくつか変数を作るよ"

translate Japanese _call_mas_wx_cmd_79_a43a44bd:
    m 3eub "そして比較演算も作って、と"

translate Japanese _call_mas_wx_cmd_84_9d188452:
    m 1eua "色々な型の真偽値を知れば、比較演算を効率的に行えるようになるわ"

translate Japanese _call_mas_wx_cmd_84_aa61ecdc:
    m 1hua "これからのレッスンでは、どんなときにどんな比較演算の効率がいいのかについても教えていくね"

translate Japanese _call_mas_wx_cmd_84_b43554c2:
    m 1hua "ご清聴、ありがとうございました！"
