translate Japanese mas_updater_steam_issue_93407258:
    m 1eub "[player]君！Steamを使っているみたいね。"
...
translate Japanese mas_updater_steam_issue_3a7754fe:
    m 1eksdla "このMODのサイトの配布ページから手動でアップデートファイルをインストールしなきゃいけないわ。{a=http://www.monikaafterstory.com/releases.html}ここをクリックすると配布ページに行けるから。"
